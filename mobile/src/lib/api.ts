import {
  ...
  type ApiErrorBody, type ClaimIdRequest, type DiscardUploadRequest, type DiscardUploadResponse, type ErrorCode,
...
export function createApi(deps: ApiDeps) {
  ...
  return {
    ...
    discardUpload: (req: DiscardUploadRequest) => call<DiscardUploadResponse>(API.discardUpload, req),
